...
<body>
    ...
    <main class="container-principal-cliente">
            <div class="container-principal-cliente__fundo-cards">
                <a href="http://parkingclub.com.br/telaCliente/reservaVaga.php" class="container-principal-cliente__fundo-cards__card">
                    <img src="../componentes/images/reservar-vaga_icon.png" alt="" srcset="" style="width: 80px; height: 80px"> 
                    <p> RESERVA DE VAGA </p>
                </a>

                <a href="http://parkingclub.com.br/telaCliente/pagarSaida.php" class="container-principal-cliente__fundo-cards__card">
                    <img src="../componentes/images/pagamento_icon.png" alt="" srcset="" style="width: 80px; height: 80px">
                    <p> PAGAR SAÍDA </p>
                </a>

                <a href="http://parkingclub.com.br/telaCliente/suporte.php" class="container-principal-cliente__fundo-cards__card">
